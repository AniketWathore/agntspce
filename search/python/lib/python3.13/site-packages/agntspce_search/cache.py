...
from agntspce_search.index.file_walker import walk_files
from agntspce_search.index.files import FileStatus, get_extensions, get_file_status
from agntspce_search.index.types import PersistencePath
from agntspce_search.types import ContentType
from agntspce_search.utils import is_git_url, resolve_model_name
...
def _get_valid_user_cache_dir() -> Path | None:
    ...
    user_cache_location = os.getenv(env_var("CACHE_LOCATION"))
...
def resolve_cache_folder() -> Path:
    """Resolves a cache folder."""
    name = "agntspce/search"
