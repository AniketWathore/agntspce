...
from agntspce_search.cache import resolve_cache_folder
from agntspce_search.types import CallType, SearchResult
...
def format_savings_report(path: Path | None = None) -> str:
    ...
    lines = [
        "",
        "  " + _color("1;36", "AgntSpce Search Token Savings", color),
        heavy_line,
        "",
