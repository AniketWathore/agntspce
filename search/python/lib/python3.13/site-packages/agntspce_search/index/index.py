...
from agntspce_search.cache import get_validated_cache
from agntspce_search.index.create import create_index_from_path
from agntspce_search.index.dense import SelectableBasicBackend, load_model
from agntspce_search.index.files import read_file_text
from agntspce_search.index.types import PersistencePath
from agntspce_search.search import _search_semantic, search
from agntspce_search.stats import save_search_stats
from agntspce_search.types import CallType, Chunk, ContentType, IndexStats, SearchResult
...
class SembleIndex:
    ...
    def save(self, path: Path | str) -> None:
        ...
        with open(persistence_paths.chunks, "wb") as f:
            ...
            f.write(data)
        from agntspce_search.chunking.chunking import _DESIRED_CHUNK_LENGTH_CHARS  # avoid circular import at module level
